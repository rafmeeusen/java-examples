...
/*
 * thread class that increments given Data object a given number of times and
 * then exits
 */
class DataIncrementer extends Thread {
    ...
    public void run() {
        // System.out.println( this.getName() + " started to do " +
        // nrIncrementsLeft + " increments.");
...
public class Race {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Race condition test with " + nrIncThreads + " threads, each thread doing " + nrIncsPerThread
                + " read-mod-writes.");
